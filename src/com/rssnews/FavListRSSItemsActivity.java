...
public class FavListRSSItemsActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fav_rss_item_list);
		...
		WebSite site = rssDB.getFavSite(site_id);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String page_url = ((TextView) view.findViewById(R.id.page_urlf))
						.getText().toString();
	...
	class loadRSSFeedItems extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(FavListRSSItemsActivity.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							FavListRSSItemsActivity.this, rssItemList,
							R.layout.fav_rss_item_list_row, new String[] {
									TAG_LINK, TAG_TITLE, TAG_PUB_DATE,
									TAG_DESRIPTION }, new int[] {
									R.id.page_urlf, R.id.titlef,
									R.id.pub_datef, R.id.linkf });
