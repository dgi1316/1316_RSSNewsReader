...
public class RSSListRSSItemsActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rsstab_rss_item_list);

		Intent i = getIntent();
		Integer site_id = Integer.parseInt(i.getStringExtra("id"));
		RSSDatabaseHandler rssDB = new RSSDatabaseHandler(
				getApplicationContext());
		WebSite site = rssDB.getRSSTabSite(site_id);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String page_url = ((TextView) view
						.findViewById(R.id.page_urlrt)).getText().toString();
	...
	class loadRSSFeedItems extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(RSSListRSSItemsActivity.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							RSSListRSSItemsActivity.this, rssItemList,
							R.layout.rsstab_rss_item_list_row, new String[] {
									TAG_LINK, TAG_TITLE, TAG_PUB_DATE,
									TAG_DESRIPTION }, new int[] {
									R.id.page_urlrt, R.id.titlert,
									R.id.pub_datert, R.id.linkrt });
