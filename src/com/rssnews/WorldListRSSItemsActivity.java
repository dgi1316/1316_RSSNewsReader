...
public class WorldListRSSItemsActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		WebSite site = rssDB.getWorldSite(site_id);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String page_url = ((TextView) view.findViewById(R.id.page_urlw))
						.getText().toString();
	...
	class loadRSSFeedItems extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(WorldListRSSItemsActivity.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							WorldListRSSItemsActivity.this, rssItemList,
							R.layout.world_rss_item_list_row, new String[] {
									TAG_LINK, TAG_TITLE, TAG_PUB_DATE,
									TAG_DESRIPTION }, new int[] {
									R.id.page_urlw, R.id.titlew,
									R.id.pub_datew, R.id.linkw });
